 ...
 * @property string $fio - ФИО получателя*
 * @property string $zip - индекс получателя*
 * @property string $region - регион получателя
 * @property string $city - город получателя
 * @property string $address - адрес получателя*
 * @property string $phone1 - телефон получателя*
 * @property string $phone2 - дополнительный телефон получателя
 * @property string $email - e-mail адрес получателя
